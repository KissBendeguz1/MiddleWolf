...
function getProfileData() {
    ...
    xhlProfile.send(JSON.stringify({
        id: profileId
    }));
}
...
xhrPrivateDocsAlkID.open('POST', `${API_BASE_URL}/docs/private/alkalmazottId`, true);
        ...
        if (xhrPrivateDocsAlkID.status === 200) {
            try {
                ...
                if (response.documents && Array.isArray(response.documents)) {
                    ...
                    console.warn("Nincsenek privát dokumentumok vagy rossz a válasz formátuma.");
                }
            } catch (e) {
...
if (selectedComp) {
    xhrPrivateDocsAlkID.send(JSON.stringify({ 
